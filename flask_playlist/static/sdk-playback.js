...
<html lang="en" style="height: 100%">
    <head>
        ...
        <script type="text/javascript">
            var Anywhere = {};
            Anywhere.urls = {};
            Anywhere.csrfToken = "yOMw6aEMRH7cC9urAduceZ9qsW591icaEldwmILEItxzaVg8uQV9NCjzOCpl6yBJ";
        </script>
...
<li class="visible-xs"><a href="https://blog.pythonanywhere.com/" class="blog_link">Blog</a></li>
  ...
  <form class="form" action="" method="post"><input type='hidden' name='csrfmiddlewaretoken' value='yOMw6aEMRH7cC9urAduceZ9qsW591icaEldwmILEItxzaVg8uQV9NCjzOCpl6yBJ' />
    <table>
